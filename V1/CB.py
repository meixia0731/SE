...
def CB_SIMULATOR(modbus_slave_ip, cb_type):
    ...
    while True:
        ...
        if cb_status_int[0] == 4:
            ...
            slave_1.set_values('A', P_addr[0], int(P_addr[1]*random.uniform(0.98, 1.02)))
...
if __name__ == "__main__":
    CB1 = Process(target=CB_SIMULATOR, args=(modbus_slave_ip1, 'MTZ2'))
    CB2 = Process(target=CB_SIMULATOR, args=(modbus_slave_ip2, 'MTZ2'))
    CB3 = Process(target=CB_SIMULATOR, args=(modbus_slave_ip3, 'MTZ2'))
    CB4 = Process(target=CB_SIMULATOR, args=(modbus_slave_ip4, 'MTZ2'))
    CB5 = Process(target=CB_SIMULATOR, args=(modbus_slave_ip5, 'MTZ2'))
